...
- **Массовые операции** — Запустить все / Остановить все с диалогом подтверждения, массовая перепроверка кнопкой Rehash
...
│   ├── app.slint
│   └── app-icon.png
├── assets/images/       ← SVG-иконки тулбара, лого, github.svg
└── src/
